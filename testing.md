...
5) Of sufficient depth and breadth that we can rely on them for deployment (aspirational)

Testing Conventions
-------------------
These conventions make it much easier for someone familiar with our platform but unfamiliar with a particular component to quickly jump in, understand the code, and be productive writing code and updating/creating tests.
